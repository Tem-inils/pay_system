from sqlalchemy import Column, String, DateTime, Float, Integer, ForeignKey, Boolean, Numeric, Enum as SqlEnum, func
...
class Account(Base):
    ...
    currency: Mapped[AccountCurrency] = mapped_column(SqlEnum(AccountCurrency), nullable=False)
